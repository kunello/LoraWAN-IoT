...
//              Serial.println(F("Received ack"));
            ...
            os_setTimedCallback(&sendjob, os_getTime()+sec2osticks(TX_INTERVAL), do_send); //error in this line of code
...
void get_tank_level() {
  ...
  String myLevel = String(ultrasonic.read());
